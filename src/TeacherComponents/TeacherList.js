...
function TeacherList() {
  ...
  let getStudents = async () => {
    try {
      const students = await axios.get("https://647c030ac0bae2880ad055b5.mockapi.io/Students");
  ...
  let handleDelete = async (id) => {
    try {
      ...
      if (confirmDelete) {
        await axios.delete(`https://647c030ac0bae2880ad055b5.mockapi.io/Students/${id}`);
        getStudents();
      }
    } catch (error) {
      console.log(error);
