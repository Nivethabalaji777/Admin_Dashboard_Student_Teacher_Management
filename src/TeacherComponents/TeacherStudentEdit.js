...
function TeacherStudentEdit() {
    ...
    let getStudents = async () => {
        try {
            const students = await axios.get(`https://647c030ac0bae2880ad055b5.mockapi.io/Students/${params.id}`);
    ...
    const myFormik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                setLoading(true);
                await axios.put(`https://647c030ac0bae2880ad055b5.mockapi.io/Students/${params.id}`, values);
                setLoading(false);
